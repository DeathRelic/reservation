...
<base href="<%=basePath%>">
<%
	String passwordMemberUrl = basePath + "WEB-INF/pages/back/member/add.action" ;
%>
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="panel panel-failure">
				<div class="panel-heading">
					<strong><i class="fa fa-user-md"></i>&nbsp;修改密码</strong>
				</div>
				<div class="panel-body">
					<form action="back/pwdChange.action" id="myform" method="post" class="form-horizontal">
